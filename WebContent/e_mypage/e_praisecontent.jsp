...
<c:if test="${!empty edto }"><center><button type="button" class="btn btn-primary btn-md" onclick="javascript:window.location='/antman/e_praiseupdate.do?pid=${edto.pid}&eid=${edto.eid}'">수정하기</button></c:if>
<button type="button" class="btn btn-primary btn-md" onclick="javascript:window.location='/antman/e_praisedelete.do?pid=${edto.pid}&eid=${edto.eid}'">삭제하기</button> 
 <button type="button" class="btn btn-primary btn-md" onclick="javascript:window.location='/antman/e_praiseboard.do?pid=${edto.pid}&eid=${edto.eid}'">목록으로</button></center>
  </center>
</body>
</html>
