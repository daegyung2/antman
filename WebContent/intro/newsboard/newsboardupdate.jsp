...
<div id="container">
 ...
 <form action="/antman/newsboardupdatepro.do" method="post">
  <input type="hidden" name="NEid" value="${dto.NEid}">
    ...
    <tr><td colspan="2"><input type="submit" value="글 수정"/><button type="button" class="btn btn-primary btn-md" onclick="javascript:window.location='/antman/newsboard.do'">목록으로</button></td></tr>
