...
<div id="container">
  ...
  <input type="hidden" name="MBid" value="${dto.MBid}">
    ...
    <tr><td colspan="2"><center><input type="submit" value="글 수정"/><button type="button" class="btn btn-primary btn-md" onclick="javascript:window.location='/spring/mainboard.do'">목록으로</button></center></td></tr>
