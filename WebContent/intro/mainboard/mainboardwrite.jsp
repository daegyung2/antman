...
<div id="container">
    ...
    <tr><td colspan="2"><center><input type="submit" value="글 등록"/><button type="button" class="btn btn-primary btn-md" onclick="javascript:window.location='/antman/mainboard.do'">목록으로</button></center></td></tr>
