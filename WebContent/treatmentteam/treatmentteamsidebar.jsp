...
<style type="text/css">
	...
	.sidebar{width:200px; height:1660px; float:left; margin-left:35px; top:95px; position:absolute; border:1px solid #BDBDBD; border-top:1px solid transparent; border-bottom:1px solid transparent; z-index:200;}
