...
<body>
<table width="698" border="1" cellpadding="1" cellspacing="0">
<tr>
<th width="207">부모 부서</th>
<td> ${dto.p_depart_id }.${pdto.p_dpname} </td>
</tr>
<tr>
<th width="207">진료과 이름</th>
<td>${dto.dpname }</td>
</tr>
<tr >
<th width="207">진료과 이니셜</th>
<td>${dto.init }</td>
</tr>
<tr >
<th width="207">진료과 사진</th>
<td align="center"><img src="${dto.dpimg}" width="110" height="110"/></td>
</tr>
<tr>
<th width="207">진료과 정보1</th>
<td>${dto.d_info1 }</td>
</tr>
<tr>
<th width="207">진료과 정보2</th>
<td>${dto.d_info2 }</td>
</tr>
<tr>
<th width="207">진료과 정보3</th>
<td>${dto.d_info3 }</td>
</tr>
<tr>
<th width="207">진료과 정보4</th>
<td>${dto.d_info4 }</td>
</tr>
<tr>
<th width="207">진료과 정보5</th>
<td>${dto.d_info5 }</td>
</tr>
<tr>
<th width="207">진료과 정보6</th>
<td>${dto.d_info6 }</td>
</tr>
<tr>
