...
<style type="text/css">
	...
	#container{ width:1100px; height:1170px; margin:0 auto; margin-left:250px; position:relative;}
	#container .main{ width:1000px; height:1100px; margin-left:50px; position:relative}
...
<INPUT type=radio name="agree" id="no" value="no" >동의하지 않습니다.<BR><BR>
		     ...
		     <div class="content">
			<div id="title_2"><b>개인정보 수집 이용에 대한 안내</b></div>
			<div id="main_text">
			수집하는 개인정보 항목 : 이름, 휴대전화번호
			수집ㆍ이용목적 : 진료 예약 및 진료 안내<br/>
			보유 및 이용 기간 : 의료법에 준함<br/>
			개인정보 수집 이용 동의는 거부하실 수 있으며, 거부할 경우 서비스 사용이 일부 제한될 수 있습니다.
		
			</div>
			<div id="radio">
<form action="appointmentdetail.do" method="post" name="userinput" onSubmit="return checkIt()">
<INPUT type=radio name="agreee" id="yes" value="yes" checked>동의합니다.&nbsp;
<INPUT type=radio name="agreee" id="no" value="no" >동의하지 않습니다.<BR><BR>
			</div>
		</div>
		<div class="writeform">
			<div class="sub">
