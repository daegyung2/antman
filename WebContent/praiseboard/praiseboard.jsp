...
<style type="text/css">
	...
	#container{width:1100px; height:1309px; margin:0 auto;  margin-left:230px; margin-top:-50px; position:relative;}
	#container .main{width:1000px; height:1200px; margin-left:50px; margin-top:100px; position:relative}
