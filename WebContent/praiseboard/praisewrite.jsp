...
<input type="submit" value="선생님선택">
    ...
    <tr><td colspan="2"><input type="submit" value="칭찬하기"/><button type="button" class="btn btn-primary btn-md" onclick="javascript:window.location='/antman/praiseboard.do?pid=${dto.pid}&name=${dto.name}&id=${dto.id}'">목록으로</button></td></tr>
