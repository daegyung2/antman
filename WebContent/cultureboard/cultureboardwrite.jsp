...
<form action="/antman/cultureboardPro.do" method="post" enctype="multipart/form-data">
    ...
    <tr><td colspan="2"><input type="submit" value="글 등록"/><button type="button" class="btn btn-primary btn-md" onclick="javascript:window.location='/spring/cultureboard.do'">목록으로</button></td></tr>
